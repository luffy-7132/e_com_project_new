class SpecialForYouModel {
  ...
  SpecialForYouModel({this.totalSize, this.limit, this.offset, this.products});

  SpecialForYouModel.fromJson(Map<String, dynamic> json) {
...
class Products {
  ...
  Products.fromJson(Map<String, dynamic> json) {
    ...
    attributes = json['attributes'].cast<num>();
